...
# !!! Main.UserApp is configured as an alias for Main.SocEstimator and you might encounter it in some tests
using Main.SocEstimator, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "SocEstimator tests" begin
  @includetests ARGS
end
